...
app = dash.Dash(  
    ...
    meta_tags=[  
        ...
        {"name": "description", "content": "Dashboard de Produtividade da Soja no RS usando Random Forest"},  
...
def create_feature_importance_graph(theme="light", is_mobile=False):  
    ...
    fig = go.Figure(  
        go.Bar(  
            ...
            textposition="inside",  
            textfont=dict(color="white", size=10 if is_mobile else 12, family="Arial Black"),  
    ...
    fig.update_layout(  
        title={  
            ...
            "x": 0.5,  
            "xanchor": "center",  
            "font": {"size": title_size, "family": "Arial Black", "color": cor_detalhes},  
        },  
...
def create_predictions_graph(theme="light", is_mobile=False):  
    ...
    fig.update_layout(  
        title={  
            "text": "📊 Predições vs. Reais" if is_mobile else "📊 Predições vs. Valores Reais",  
            "x": 0.5,  
            "xanchor": "center",  
            "font": {"size": title_size, "family": "Arial Black", "color": cor_detalhes},  
        },  
...
def create_metric_card(  
    title, value, icon, color_class="success", subtitle=None, theme="light", is_mobile=False  
):  
    if theme == "dark":  
                            ...
                            (  
                                html.Small(  
                                    ...
                                    style={  
                                        ...
                                        "fontSize": "0.8rem" if is_mobile else "0.875rem"  
                                    }  
                                )  
                                if subtitle  
                                else None  
                        ...
                        dbc.Row(  
                            [  
                                dbc.Col(  
                                    ...
                                    xs=12, sm=6, className="mb-3 mb-sm-0"  
                                ),  
                                dbc.Col(  
                            ...
                            [  
                                ...
                                html.P(  
                                    [  
                                        ...
                                        html.Span(" | Modelo: Random Forest 🌱", className="d-none d-md-inline"),  
                                        html.Span("Random Forest 🌱", className="d-md-none"),  
                                    ],  
                                    id="footer-text",  
                                    className="text-center",  
                                ),  
...
def update_theme(theme, is_mobile):  
    ...
    subtitle_text = (  
        ...
        if is_mobile else  
        "Modelagem computacional utilizando Random Forest com dados de temperatura (°C) e precipitação (mm) de janeiro de 2018 a fevereiro de 2025, visando identificar padrões e realizar previsões climáticas."  
    )  
    ...
    theme_toggle_style = {  
        ...
        "top": "10px",  
        "right": "10px",  
        "height": "40px" if is_mobile else "50px",  
        "width": "40px" if is_mobile else "50px",  
        "background": "transparent",  
        "border": f"1px solid {cor_detalhes}",  
        "borderRadius": "50%",  
        "cursor": "pointer",  
        "fontSize": "1.2rem" if is_mobile else "1.5rem",  
        "display": "flex",  
        "alignItems": "center",  
...
@callback(  
    ...
    [Input("selected-year-store", "data"), Input("theme-store", "data"), Input("mobile-store", "data")],  
)  
                ...
                [  
                    html.H4(  
                        [  
                            ...
                            "Dados Históricos" if is_mobile else "Dados Históricos por Ano",  
                        ],  
                        className="mb-0 fw-bold",  
                        style={  
                            "color": cor_detalhes,  
